"""Tests for test_api_v320 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV320Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v320", "version": 3, "batch_size": 96}
...
class TestTestApiV320Processing:
...
class TestTestApiV320EdgeCases:
