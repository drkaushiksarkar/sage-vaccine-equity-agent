"""RegressionValidatorsV4S36: regression_validators_v4_s36 module v4.
...
@dataclass
class RegressionValidatorsV4S36Config:
    """Configuration for regression_validators_v4_s36 v4."""
    batch_size: int = 128
    hidden_dim: int = 512
    num_layers: int = 6
    dropout: float = 0.4
...
class RegressionValidatorsV4S36(nn.Module):
    """Neural network module for regression_validators_v4_s36 v4.
    ...
    def __init__(self, config: Optional[RegressionValidatorsV4S36Config] = None):
        super().__init__()
        self.config = config or RegressionValidatorsV4S36Config()
        c = self.config
        ...
        logger.info("Initialized RegressionValidatorsV4S36 v4 with %d params",
