"""CachingValidatorsV4S22: caching_validators_v4_s22 module v4.
...
@dataclass
class CachingValidatorsV4S22Config:
    """Configuration for caching_validators_v4_s22 v4."""
    batch_size: int = 128
    hidden_dim: int = 512
    num_layers: int = 6
    dropout: float = 0.4
...
class CachingValidatorsV4S22(nn.Module):
    """Neural network module for caching_validators_v4_s22 v4.
    ...
    def __init__(self, config: Optional[CachingValidatorsV4S22Config] = None):
        super().__init__()
        self.config = config or CachingValidatorsV4S22Config()
        c = self.config
        ...
        logger.info("Initialized CachingValidatorsV4S22 v4 with %d params",
