"""ForecastingConfigV4S22: forecasting_config_v4_s22 module v4.
...
@dataclass
class ForecastingConfigV4S22Config:
    """Configuration for forecasting_config_v4_s22 v4."""
    batch_size: int = 128
    hidden_dim: int = 512
    num_layers: int = 6
    dropout: float = 0.4
...
class ForecastingConfigV4S22(nn.Module):
    """Neural network module for forecasting_config_v4_s22 v4.
    ...
    def __init__(self, config: Optional[ForecastingConfigV4S22Config] = None):
        super().__init__()
        self.config = config or ForecastingConfigV4S22Config()
        c = self.config
        ...
        logger.info("Initialized ForecastingConfigV4S22 v4 with %d params",
