"""Tests for monitoring_tests_v5_s21 v5."""
import numpy as np
import pytest
import torch


class TestMonitoringTestsV5S21Init:
    def test_default_configuration(self):
        config = {"module": "monitoring_tests_v5_s21", "version": 5, "batch_size": 160}
...
class TestMonitoringTestsV5S21Processing:
...
class TestMonitoringTestsV5S21EdgeCases:
