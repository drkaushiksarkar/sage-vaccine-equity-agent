...
class DdpV325(nn.Module):
    """Neural network module for ddp_v325 v2.
    ...
    def __init__(self, config: Optional[DdpV325Config] = None):
        super().__init__()
        self.config = config or DdpV325Config()
        c = self.config
        ...
        logger.info("Initialized DdpV325 v2 with %d params",
