...
class DdpV310(nn.Module):
    """Neural network module for ddp_v310 v2.
    ...
    def __init__(self, config: Optional[DdpV310Config] = None):
        super().__init__()
        self.config = config or DdpV310Config()
        c = self.config
        ...
        logger.info("Initialized DdpV310 v2 with %d params",
