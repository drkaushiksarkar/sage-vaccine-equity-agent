...
class DdpV340(nn.Module):
    """Neural network module for ddp_v340 v2.
    ...
    def __init__(self, config: Optional[DdpV340Config] = None):
        super().__init__()
        self.config = config or DdpV340Config()
        c = self.config
        ...
        logger.info("Initialized DdpV340 v2 with %d params",
