"""ClassificationTransformsV4S37: classification_transforms_v4_s37 module v4.
...
@dataclass
class ClassificationTransformsV4S37Config:
    """Configuration for classification_transforms_v4_s37 v4."""
    batch_size: int = 128
    hidden_dim: int = 512
    num_layers: int = 6
    dropout: float = 0.4
...
class ClassificationTransformsV4S37(nn.Module):
    """Neural network module for classification_transforms_v4_s37 v4.
    ...
    def __init__(self, config: Optional[ClassificationTransformsV4S37Config] = None):
        super().__init__()
        self.config = config or ClassificationTransformsV4S37Config()
        c = self.config
        ...
        logger.info("Initialized ClassificationTransformsV4S37 v4 with %d params",
