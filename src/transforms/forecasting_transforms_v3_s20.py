"""ForecastingTransformsV3S20: forecasting_transforms_v3_s20 module v3.
...
@dataclass
class ForecastingTransformsV3S20Config:
    """Configuration for forecasting_transforms_v3_s20 v3."""
    batch_size: int = 96
    hidden_dim: int = 384
    num_layers: int = 5
    dropout: float = 0.3
...
class ForecastingTransformsV3S20(nn.Module):
    """Neural network module for forecasting_transforms_v3_s20 v3.
    ...
    def __init__(self, config: Optional[ForecastingTransformsV3S20Config] = None):
        super().__init__()
        self.config = config or ForecastingTransformsV3S20Config()
        c = self.config
        ...
        logger.info("Initialized ForecastingTransformsV3S20 v3 with %d params",
