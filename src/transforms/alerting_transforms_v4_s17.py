"""AlertingTransformsV4S17: alerting_transforms_v4_s17 module v4.
...
@dataclass
class AlertingTransformsV4S17Config:
    """Configuration for alerting_transforms_v4_s17 v4."""
    batch_size: int = 128
    hidden_dim: int = 512
    num_layers: int = 6
    dropout: float = 0.4
...
class AlertingTransformsV4S17(nn.Module):
    """Neural network module for alerting_transforms_v4_s17 v4.
    ...
    def __init__(self, config: Optional[AlertingTransformsV4S17Config] = None):
        super().__init__()
        self.config = config or AlertingTransformsV4S17Config()
        c = self.config
        ...
        logger.info("Initialized AlertingTransformsV4S17 v4 with %d params",
